...
function ColourPalette(){
	...
	this.colours = ["black", "silver","DimGrey", "LightSlateGrey", "maroon", "red","OrangeRed", "MediumVioletRed", "purple", "orange", "pink", "DeepPink", "fuchsia", "green", "SeaGreen","lime", "Chartreuse", "olive", "OliveDrab","yellow", "navy", "blue", "DarkSlateBlue", "teal","aqua", "MediumAquaMarine","Brown", "SaddleBrown"];
	...
	this.loadColours = function(){
		...
		$(".colourSwatches").first().css("border", "2px dashed white");
	};
